...
//una vez el usuario ya ingresó el monto, y el descuento, se hizo la cuenta, ahora se muestra el resultado de la cuenta al usuario
	...
	Mostrar "Entonces el producto, aplicando el descuento, le costaría " resultadoDescuento " pesos :D"
	//resultadoDescuento = precioArticulo - ((precioArticulo / 100) * porcentajeDescuento)
